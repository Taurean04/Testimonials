const custImage = document.getElementById('customer-img');
const custName = document.getElementById('customer-name');
const custText = document.getElementById('customer-text');
...
btns.forEach(btn => {
    btn.addEventListener('click', e => {
        ...
        custImage.src = customers[index].img;
        custName.textContent = customers[index].name;
